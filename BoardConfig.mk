...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/y2s/prebuilt/kernel
TARGET_PREBUILT_DTB := device/samsung/y2s/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/y2s/prebuilt/recovery_dtbo
...
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/y2s/bootimg.mk
